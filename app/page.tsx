        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {Array.from({ length: 9 }, (_, index) => (
            <motion.div
              ...
              className="relative"
            >
              <Link href={index === 0 ? "/forest" : "/"} className="block">
                <div className="relative bg-white/10 backdrop-blur-md rounded-2xl p-8 text-center hover:bg-white/20 transition-all duration-300 shadow-xl hover:shadow-2xl h-64 flex items-center justify-center border border-white/20">
                  <div className="absolute inset-0 bg-gradient-to-r from-blue-600/20 to-purple-600/20 rounded-2xl" />
                  <div>
                    <h3 className="text-2xl font-bold mb-3">Portfolio {index + 1}</h3>
